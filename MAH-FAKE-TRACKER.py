...
GALLERY_PATHS = [
    "/sdcard/DCIM/Camera",
    "/sdcard/DCIM/MAH_Tracker", 
    "/sdcard/Pictures/MAH_Tracker",
    "/sdcard/Download/MAH_Tracker"
]
...
def display_banner():
    ...
    print(f"{Back.RED}{Fore.GREEN}{' MAH FAKE TRACKER '.center(60)}{Style.RESET_ALL}")
    print(f"{Back.RED}{Fore.WHITE}{' by easy-xack '.center(60)}{Style.RESET_ALL}")
    ...
    try:
        ...
        for i, photo_data in enumerate(photos):
            try:
                ...
                filename = f"MAH_Photo_{timestamp_str}_{i+1}.jpg"
        ...
        if video:
            try:
                ...
                timestamp_str = datetime.now().strftime("%Y%m%d_%H%M%S")
                filename = f"MAH_Video_{timestamp_str}.webm"
